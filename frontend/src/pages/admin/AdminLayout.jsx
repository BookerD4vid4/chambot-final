...
import {
    ...
    Store, Layers, BarChart2, Bell, ChevronRight, Users, MapPin
} from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { to: '/admin/delivery-settings', icon: <MapPin size={17} />, label: 'พื้นที่จัดส่ง' },
    ...
    const getCurrentTitle = () => {
        ...
        if (path.includes('delivery-settings')) return 'ตั้งค่าพื้นที่จัดส่ง';
        return 'Admin';
    };
