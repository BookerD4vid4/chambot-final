...
const CheckoutPage = () => {
    ...
    const [newAddr, setNewAddr] = useState({ recipient_name: '', address_line: '', province: '', amphoe: '', tambon: '', postal_code: '' });
    ...
    const handleAddAddress = async () => {
        ...
        try {
            ...
            setNewAddr({ recipient_name: '', address_line: '', province: '', amphoe: '', tambon: '', postal_code: '' });
                                    ...
                                    <button type="button" className="profile-add-addr-btn" onClick={() => {
                                        ...
                                        if (deliverySettings?.is_locked) {
                                            setNewAddr({
                                                ...
                                                amphoe: deliverySettings.amphoe,
                                                tambon: deliverySettings.tambon,
